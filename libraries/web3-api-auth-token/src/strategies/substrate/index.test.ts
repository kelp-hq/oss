...
describe('Substrate', () => {
  ...
  const tokenString = `c3Vi.eyJuZXR3b3JrIjoiYW5hZ29sYXkiLCJwcmVmaXgiOjQyLCJhY2NvdW50IjoiNUZBOW5RRFZnMjY3REVkOG0xWnlwWExCbnZON1NGeFl3VjduZHFTWUdpTjlUVHB1In0=.IjB4Zjk5OTJiNjUwNGExYjBiMTY5YmY0NTZlODAyNjc4YzZkN2NiNzRkZTA0ODAyNDliNTk0YTU5NWFkZmI5MzY5ZDllMTBlNjcyMWI5MWVlMmY2Y2JhODI5YzVmOTQ1Njg2NWViNWI2NTUyYzg5NjEwZDA1YjJmNDZlY2VjZGE3MDci`;
  ...
  beforeEach((): void => {
    ...
    // console.log(JSON.stringify(alice.addressRaw));
  });
